...
public class AppleMusicAPIResponseConverter {
    ...
    public List<ConfetiArtist> convertToConfetiArtists(final AppleMusicSearchResponse searchResult) {
    ...
    public List<ConfetiMusic> convertToConfetiMusics(final AppleMusicMusicsResponse musics) {
    ...
    public List<ConfetiMusic> convertToConfetiMusics(final AppleMusicChartsResponse charts) {
    ...
    public MusicPage convertToConfetiMusicPage(AppleMusicArtistMusicsResponse artistMusics) {
    ...
    public MusicPage convertToConfetiMusicPage(AppleMusicSearchResponse searchResult) {
        return Optional.ofNullable(searchResult)
                .map(AppleMusicSearchResponse::results)
