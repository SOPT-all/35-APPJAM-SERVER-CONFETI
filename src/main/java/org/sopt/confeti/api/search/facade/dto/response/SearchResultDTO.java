...
public record SearchResultDTO(
    ...
    public static SearchResultDTO of(ConfetiArtist artist, boolean artistFavorite, List<SearchedPerformance> performances,
                                     Set<Long> favoritePerformanceIds) {
    ...
    public static SearchResultDTO of(SearchedPerformance performance, boolean performanceFavorite) {
        return new SearchResultDTO(
                null,
